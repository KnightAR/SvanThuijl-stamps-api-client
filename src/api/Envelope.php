...
class Envelope extends AbstractClient implements EnvelopeInterface
{
    ...
    const RATE_PRINT_LAYOUT_ENVELOPE9          = 'Envelope9';
    const RATE_PRINT_LAYOUT_ENVELOPE10         = 'Envelope10';
    const RATE_PRINT_LAYOUT_ENVELOPE11         = 'Envelope11';
    const RATE_PRINT_LAYOUT_ENVELOPE12         = 'Envelope12';
    const RATE_PRINT_LAYOUT_ENVELOPEPERSONAL   = 'EnvelopePersonal';
    const RATE_PRINT_LAYOUT_ENVELOPEMONARCH    = 'EnvelopeMonarch';
    const RATE_PRINT_LAYOUT_ENVELOPEINVITATION = 'EnvelopeInvitation';
    const RATE_PRINT_LAYOUT_ENVELOPEGREETING   = 'EnvelopeGreeting';
